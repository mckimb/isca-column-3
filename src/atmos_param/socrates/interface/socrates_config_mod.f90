...
LOGICAL :: l_planet_grey_surface = .TRUE.
  ...
  logical :: account_for_effect_of_ozone=.FALSE. !if False then radiation is fed ozone mixing ratios = 0. If true it's fed mixing ratios based on model ozone field.
  ...
  REAL(r_def) :: co_mix_ratio = 0.0
  REAL(r_def) :: n2o_mix_ratio = 0.0
  REAL(r_def) :: ch4_mix_ratio = 0.0
  REAL(r_def) :: o2_mix_ratio = 0.0
  ! REAL(r_def) :: o2_mix_ratio = 0.2314
  REAL(r_def) :: so2_mix_ratio = 0.0
  REAL(r_def) :: cfc11_mix_ratio = 0.0
  REAL(r_def) :: cfc12_mix_ratio = 0.0
  REAL(r_def) :: cfc113_mix_ratio = 0.0
  REAL(r_def) :: hcfc22_mix_ratio = 0.0
  REAL(r_def) :: hfc134a_mix_ratio = 0.0
